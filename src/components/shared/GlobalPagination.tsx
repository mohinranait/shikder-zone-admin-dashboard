      ...
      if (
        ...
        pageNumbers.push(
          <button
            ...
            className={`rounded-md !min-w-10 px-3 py-1 text-sm font-medium ${
              currentPage === i
                ? "bg-primary text-white cursor-not-allowed"
                : "hover:bg-gray text-black hover:text-black"
            }`}
          >
            {i}
          </button>
          ...
          >
            <button
              ...
              className={`relative inline-flex  items-center rounded-l-md px-2 py-2 text-gray ${
                currentPage === 1
                  ? "cursor-not-allowed"
                  : "hover:text-gray border border-background hover:border hover:border-gray"
              }`}
            >
